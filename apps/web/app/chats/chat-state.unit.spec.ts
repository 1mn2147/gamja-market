...
describe('WBS-04 chat message state', () => {
  it('deduplicates a retried client message by its stable id', () => {
    const optimistic = { id: 'message-1', body: '안녕하세요', createdAt: '2026-07-18T00:00:00.000Z' };
  ...
  it('restores chronological order after reconnect delivery', () => {
    const later = { id: 'message-2', body: '두 번째', createdAt: '2026-07-18T00:00:02.000Z' };
    const earlier = { id: 'message-1', body: '첫 번째', createdAt: '2026-07-18T00:00:01.000Z' };
