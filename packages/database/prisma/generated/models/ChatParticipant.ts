...
export type ChatParticipantOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"chatRoomId" | "userId" | "joinedAt" | "lastReadAt", ExtArgs["result"]["chatParticipant"]>
...
export interface ChatParticipantDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const chatParticipantWithChatRoomIdOnly = await prisma.chatParticipant.findMany({ select: { chatRoomId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ChatParticipants and only return the `chatRoomId`
   * const chatParticipantWithChatRoomIdOnly = await prisma.chatParticipant.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ChatParticipants and only return the `chatRoomId`
   * const chatParticipantWithChatRoomIdOnly = await prisma.chatParticipant.updateManyAndReturn({
   *   select: { chatRoomId: true },
   *   where: {
   *     // ... provide filter here
   *   },
