# Graph Report - gamja-market  (2026-07-21)

## Corpus Check
- 177 files · ~193,164 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4191 nodes · 4938 edges · 187 communities (119 shown, 68 thin omitted)
...
- `ChatPage()` --calls--> `mergeMessages()`  [EXTRACTED]
  apps/web/app/chats/[chatId]/page.tsx → apps/web/app/chats/chat-state.ts
...
- 3-file cycle: `packages/database/prisma/generated/internal/prismaNamespace.ts -> packages/database/prisma/generated/models.ts -> packages/database/prisma/generated/models/VerificationCode.ts -> packages/database/prisma/generated/internal/prismaNamespace.ts`
...
## Communities (187 total, 68 thin omitted)
...
Cohesion: 0.08
Nodes (29): AuthController, Body, Controller, Get, HttpCode, Inject, Patch, Post (+21 more)
...
Cohesion: 0.22
Nodes (4): Inject, PaymentService, Injectable, PaymentAction
...
Cohesion: 0.13
Nodes (13): VerificationResult, isUniqueConstraintError(), SafetyRelationshipChange, SafetyService, Injectable, ACTIVE_TRADE_STATUSES, Inject, user (+5 more)

### Community 28 - "AuthenticatedUser"
Cohesion: 0.16
Nodes (5): AuthenticatedUser, ProductService, Injectable, TradeService, Injectable
...
Cohesion: 0.11
Nodes (9): MyProducts(), price(), Product, ProductCard(), ProductCreateForm(), ProductDetail(), ProductEditForm(), ProductFeed() (+1 more)
...
Cohesion: 0.17
Nodes (15): OptionalSession(), ProductController, Body, Controller, Delete, Get, HttpCode, Inject (+7 more)
...
Cohesion: 0.12
Nodes (8): Account, AccountPanel(), api(), ApiBody, LoginForm(), PasswordResetForm(), SignupForm(), VerifyForm()
...
Cohesion: 0.17
Nodes (14): logger, PaymentView, StoredResponse, processDueSettlements(), requestPayout(), LedgerEntryType, OutboxStatus, PaymentStatus (+6 more)
...
Cohesion: 0.11
Nodes (15): AdminController, Body, Controller, Get, Inject, Param, Post, Req (+7 more)

### Community 46 - "AuthenticatedRequest"
Cohesion: 0.19
Nodes (15): AuthenticatedRequest, TradeController, Body, Controller, Get, Inject, Param, Post (+7 more)
...
Cohesion: 0.10
Nodes (13): AppModule, HttpProblemFilter, requestContext, requestContextMiddleware(), bootstrap(), ObservabilityService, Injectable, configured (+5 more)

### Community 76 - "ProductService"
Cohesion: 0.32
Nodes (10): PaymentController, Body, Controller, Get, HttpCode, Param, Post, Req (+2 more)
...
### Community 83 - "session.guard.ts"
Cohesion: 0.13
Nodes (12): AdminGuard, Injectable, readCookie(), SessionGuard, SessionRequest, Injectable, NeighborhoodController, Controller (+4 more)
...
### Community 87 - "SendMessageDto"
Cohesion: 0.29
Nodes (4): Inject, Inject, TossSandboxAdapter, Injectable

### Community 88 - "safety.controller.ts"
Cohesion: 0.24
Nodes (10): connection, logger, start(), dispatchOutboxJobs(), finish(), lookupPayment(), processOutboxEvent(), processPaymentWebhook() (+2 more)
...
Cohesion: 0.28
Nodes (3): Trade, TradeDetail(), TradeList()
...
Cohesion: 0.22
Nodes (9): 1. 문서 목적, 2. 아키텍처 원칙, 4. 저장소 구성, 5. 개발 단계, 6. 개발 명령 계약, 7. 선택하지 않은 대안, 8. 업그레이드 정책, 9. 공식 참고 자료 (+1 more)
...
Cohesion: 0.42
Nodes (7): ConfirmPaymentDto, CreatePaymentOrderDto, PaymentReasonDto, IsString, Matches, MaxLength, MinLength

### Community 104 - "[chatId]/page.tsx"
Cohesion: 0.48
Nodes (4): ChatMessage, mergeMessages(), ChatDetail, ChatPage()
...
### Community 107 - "3. 확정 기술 기준선"
Cohesion: 0.29
Nodes (7): 3.1 코어 런타임, 3.2 프런트엔드, 3.3 백엔드, 3.4 데이터와 검색, 3.5 큐와 실시간 처리, 3.6 보안과 관측성, 3. 확정 기술 기준선
...
### Community 123 - "payment-client.tsx"
Cohesion: 0.29
Nodes (4): Payment, PaymentDetail(), TossPaymentClient, Window
...
Cohesion: 0.40
Nodes (4): Gamja Market, 시작하기, 품질 명령, 호스트 개발 모드
...
## Knowledge Gaps
- **2825 isolated node(s):** `name`, `version`, `private`, `dev`, `build` (+2820 more)
...
- **Why does `AuthenticatedUser` connect `AuthenticatedUser` to `ChatGateway`, `ProductController`, `enums.ts`, `AdminService`, `ChatController`, `product.controller.ts`, `session.guard.ts`, `SafetyController`, `PaymentService`, `app.module.ts`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ProductStatus` connect `app.module.ts` to `safety.controller.ts`, `product.controller.ts`, `enums.ts`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `UserStatus` connect `app.module.ts` to `enums.ts`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _2825 weakly-connected nodes found - possible documentation gaps or missing edges._
